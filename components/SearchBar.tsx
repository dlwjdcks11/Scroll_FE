...
const SearchBar:React.FC = () => {
    ...
    return (
        <SearchContainer>
            ...
            <SearchSection id="searchSection" type="text" placeholder="Search" list="search_result" onChange={checkValue} autoComplete="off"/>
                {showAutocomplete ? 
                    <datalist id="search_result">
                        <option value="별이삼샵"/>
                        <option value="더 복서"/>
                        <option value="전자오락수호대"/>
                        <option value="마음의소리"/>
                        <option value="수희0(tngmlek0)"/>
                        <option value="뷰티풀 군바리"/>
                        <option value="Ho!"/>
                        <option value="취사병 전설이 되다"/>
                        <option value="니나의 마법서랍"/>
                        <option value="먹는 인생"/>
                        <option value="집이 없어"/>
                    </datalist> 
                : null}
